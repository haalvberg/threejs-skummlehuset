...
const meg = textureLoader.load("/meg.png")
...
const megPlane = new THREE.Mesh(
    new THREE.PlaneGeometry(0.7, 1.2),
    new THREE.MeshBasicMaterial({ map: meg } )
)
scene.add(megPlane)
megPlane.position.y = 0.7
megPlane.side = THREE.DoubleSide
...
const tick = () =>
{
    ...
    ghost3.position.y = Math.sin(elapsedTime * 7 ) + Math.sin(elapsedTime * 2.5)


    megPlane.lookAt(camera.position)
